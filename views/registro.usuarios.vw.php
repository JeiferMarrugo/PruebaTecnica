          ...
          <div class="row d-flex justify-content-center">
            ...
            <div class="col-md-4">
              ...
              <div class="card card-primary">
                ...
                <!-- form start -->
                <div id="mensajes"></div>
                <form method="post" id="formulario_usuarios" action="../controllers/registro.usuarios.ct.php">
                  <div class="card-body">
                    <div class="form-group">
                      <label for="usuarios_cc">CC</label>
                      <input type="text" class="form-control" id="usuarios_cc" name="usuarios_cc" placeholder="Ingrese n° de cedula">
                    </div>
                    <div class="form-group">
                      <label for="usuarios_nombre">Nombre Completo</label>
                      <input type="text" class="form-control" id="usuarios_nombre" name="usuarios_nombre" placeholder="Ingrese nombre completo">
                    </div>
                    <div class="form-group">
                      <label for="usuarios_telefono">Telefono</label>
                      <input type="number" class="form-control" id="usuarios_telefono" name="usuarios_telefono" placeholder="Ingrese numero de telefono">
                    </div>
                    <div class="form-group">
                      <label for="usuarios_correo">Correo</label>
                      <input type="email" class="form-control" id="usuarios_correo" name="usuarios_correo" placeholder="Ingrese email">
                    </div>
                    <div class="form-group">
                      <label for="usuarios_direccion">Direccion</label>
                      <input type="text" class="form-control" id="usuarios_direccion" name="usuarios_direccion" placeholder="Ingrese direccion">
                    </div>
                  </div>
                  <!-- /.card-body -->

                  <div class="card-footer">
                    <button type="submit" id="btnEnviar" name="btnEnviar" class="btn btn-primary">Registrar Usuario</button>
                  </div>
